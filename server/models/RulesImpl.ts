...
export class LeapRule extends Rule {
    ...
    apply(index: number, changeSet: Array<Note>, melody: Melody): Array<Note> {
        ...
        if (index < 2) {
            ...
            let notePrev1 = melody.getMelody()[index - 1];
            let notePrev2 = melody.getMelody()[index - 2];
            ...
            if (deltaPrev1 > 1) {
                ...
                changeSet = changeSet.filter(n => n.compare(threshold) < deltaPrev1 && n.compare(threshold) >= 0)
            ...
            let notePrev1 = melody.getMelody()[index - 1];
            let notePrev2 = melody.getMelody()[index - 2];
            let notePrev3 = melody.getMelody()[index - 2];
