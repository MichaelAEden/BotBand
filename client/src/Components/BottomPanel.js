      ...
      <div id="bottom-panel" onDragOver={(e) => this.onDrag(e)}>
        ...
        <MDBRow id="composition-row">
          <MDBCol size="1" id="bottom-toolbar">
            <MDBIcon icon="play-circle" size="3x" className="m-1 bottom-toolbar-icon" fixed onClick={this.handlePlayComposition} />
            <MDBIcon icon="trash-alt" size="3x" className="m-1 bottom-toolbar-icon" fixed onClick={this.props.handleClearClick} />
            <MDBIcon icon="file-download" size="3x" className="m-1 bottom-toolbar-icon" fixed onClick={this.handleShowComposition} />
          </MDBCol>
          {composition}
          {emptySpaces}
        </MDBRow>
